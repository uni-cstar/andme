...
//        val statusBarAlpha = intent.getIntExtra(EXTRA_STATUS_BAR_ALPHA, defaultStatusBarAlpha)
//        when (statusBarMode) {
//            STATUS_BAR_MODE_COLOR -> {
//                if (intent.hasExtra(EXTRA_STATUS_BAR_COLOR_RES)) {
//                    val colorRes = intent.getIntExtra(EXTRA_STATUS_BAR_COLOR_RES, 0)
//                    if (colorRes > 0) {
//                        setStatusBarColor(ContextCompat.getColor(this, colorRes), statusBarAlpha)
//                    }
//                }else{
//                    setStatusBarColor(
//                            intent.getIntExtra(EXTRA_STATUS_BAR_COLOR, Color.TRANSPARENT),
//                            statusBarAlpha
//                    )
//                }
//            }
//            STATUS_BAR_MODE_TRANSPARENT -> {
//                setStatusBarTranslucentInFragment(defaultStatusBarAlpha)
//            }
//            else -> {
//                //nothing
//            }
...
//
//        private var mStatusBarAlpha: Int = 0
//
//        /**
//         * 设置传递给Fragment的参数
//         */
...
//        /**
//         * 设置透明状态栏：状态栏会覆盖内容布局
//         * @param alpha 状态栏背景的透明度
//         */
//        fun setTransparentBar(
//                @IntRange(
//                        from = 0,
//                        to = 255
//                ) alpha: Int = amStatusBar.defaultStatusBarAlpha
//        ): Builder {
//            mStatusBarMode = STATUS_BAR_MODE_TRANSPARENT
//            mStatusBarAlpha = alpha
//            return this
//        }
//
//        /**
//         * 设置状态栏颜色：即状态栏不会覆盖内容布局
//         */
...
//
//        /**
//         * 设置状态栏颜色，优先级高于[setStatusBarColor],即同时调用此方法与[setStatusBarColor]时，此方法生效
//         */
//        fun setStatusBarColorRes(@ColorRes colorId: Int, alpha: Int = amStatusBar.defaultStatusBarAlpha): Builder {
//            mStatusBarMode = STATUS_BAR_MODE_COLOR
...
//            intent.putExtra(EXTRA_STATUS_BAR_ALPHA, mStatusBarAlpha)
...
//
//        private const val EXTRA_STATUS_BAR_ALPHA = "status_bar_alpha"
//
...
//
//        private const val STATUS_BAR_MODE_TRANSPARENT = 1
//
